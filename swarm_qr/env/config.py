...
class Lidar:
    ...
    cartographier, pas à imiter un capteur tournant. Dix-neuf anneaux sur 36 degrés couvrent,
    à 2 mètres, une bande verticale de 1,3 m : trois passages à hauteur des trois étagères se
    recouvrent. Un anneau tous les 2 degrés, et non 4 : avec 4 degrés, le dessus d'une
    étagère 24 cm sous le drone n'était touché qu'à 1,4 m devant lui, et le drone est passé
    au-dessus d'une planche dans un rack vide (mesuré à l'étape 7) ; à 2 degrés, la planche est
    vue dès 3,4 m."""

    horizontal_fov_deg: float = 360.0
    vertical_fov_deg: float = 36.0
    horizontal_res_deg: float = 2.0
    vertical_res_deg: float = 2.0
